    ...
    ERC721URIStorageUpgradeable
{
    ...
    // Storage for owners, approvals, etc. 
    // (Note: these remain because ERC721Upgradeable includes them, but we list them for clarity.)
    ...
    // For demonstration, only KingBee is minted without VRF in original code
