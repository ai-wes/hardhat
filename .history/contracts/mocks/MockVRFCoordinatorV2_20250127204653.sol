...
contract MockVRFCoordinatorV2 {
    ...
    constructor() {
        // Initialize a dummy subscription
        s_currentSubId = 1;
    ...
    /**
     * @notice Returns the latest request ID for reference in tests.
     */
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) external {
        ...
        // In real Chainlink, the function is `rawFulfillRandomWords`,
        // but your contract expects `fulfillRandomWords(uint256, uint256[])`.
     ...
     */
    function createSubscription() external view returns (uint64) {
